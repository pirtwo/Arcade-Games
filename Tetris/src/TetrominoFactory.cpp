...
Tetromino *TetrominoFactory::create(TetrominoType tetroType, float scale)
{
    ...
    case TetrominoType::Straight:
        t = new Tetromino(4, 1, 0, 0, scale, *textures->at(1));
    ...
    case TetrominoType::Square:
        t = new Tetromino(2, 2, 0, 0, scale, *textures->at(2));
    ...
    case TetrominoType::ShapeL:
        t = new Tetromino(3, 2, 0, 0, scale, *textures->at(3));
    ...
    case TetrominoType::ShapeT:
        t = new Tetromino(3, 2, 0, 0, scale, *textures->at(4));
    ...
    case TetrominoType::Skew:
        t = new Tetromino(3, 2, 0, 0, scale, *textures->at(5));
